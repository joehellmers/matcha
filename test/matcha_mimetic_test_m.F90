...
contains 
  ...
  function results() result(test_results)
    ...
    test_descriptions = [ &
       test_description_t("mimetic operator testing") &
    ]   
  ...
  function results() result(test_results)
    ...
    procedure(diagnosis_function_i), pointer :: &
      ...
      test_descriptions = [ &
        ...
        ,test_description_t("test mimetic2D", mimetic2D_testing_ptr) &
    ]
    test_results = test_descriptions%run()
  end function
#endif
...
#ifndef __GFORTRAN__
  function mimetic1D_testing() result(test_passes)
    logical test_passes
  ...
  end function mimetic1D_testing
#else
  function mimetic1D_testing() result(test_diagnosis)
    logical test_passes
...
#ifndef __GFORTRAN__
  function mimetic2D_testing() result(test_passes)
    logical test_passes
...
#else
  function mimetic2D_testing() result(test_diagnosis)
    logical test_passes
    type(test_diagnosis_t) test_diagnosis
    type(output_t) output
    ! Hard coding order (k) to 2 for now
